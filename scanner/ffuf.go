...
// towerOutput 自定义 ffuf OutputProvider，收集结果到内存
...
func newTowerOutput(conf *ffuf.Config) *towerOutput {
	return &towerOutput{
...
func (o *towerOutput) Banner()                                 {}
func (o *towerOutput) Finalize() error                         { return nil }
func (o *towerOutput) Progress(status ffuf.Progress)           {}
func (o *towerOutput) Info(infostring string)                  {}
func (o *towerOutput) Error(errstring string)                  {}
func (o *towerOutput) Raw(output string)                       {}
func (o *towerOutput) Warning(warnstring string)               {}
func (o *towerOutput) PrintResult(res ffuf.Result)             {}
func (o *towerOutput) SaveFile(filename, format string) error  { return nil }
func (o *towerOutput) Reset()                                  {}
func (o *towerOutput) Cycle()                                  {}
func (o *towerOutput) SetCurrentResults(results []ffuf.Result) { o.results = results }

func (o *towerOutput) Result(resp ffuf.Response) {
	o.mu.Lock()
	defer o.mu.Unlock()
...
func (o *towerOutput) GetCurrentResults() []ffuf.Result {
	o.mu.Lock()
	defer o.mu.Unlock()
	return o.results
}
